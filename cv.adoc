...
2013::
*MiPih* : Scrum Master pendant près d'un an dans l'équipe de développement (jusqu'à 9 personnes) de la couche sécurité du projet PGIH (réécriture de l'ensemble de l'offre du MiPih, estimé initialement à 250 années homme).
