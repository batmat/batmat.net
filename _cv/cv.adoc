...
I have a particular focus on enabling people so we can scale together. I will spend the necessary time to autonomize teams so they can operate _without_ me.<=====en
...
I also have a very deep knowledge on how open-source _works_.
...
* Atlas team (7 developers,10 in August 2022): focused on maintaining *150+ OSS plugins* that are shipped inside CloudBees CI. The size of this team has fluctuated between 4 and 10. I have managed to find and hire 4 developers over the course of 4 months. <=====en
* Seven-League team (3 developers, hiring a 4th one): providing tooling to developers and making releases happen for CloudBees CI in an uneventful manner. Strong focus on acting as a catalyser for teams, and never get in the way.<=====en
