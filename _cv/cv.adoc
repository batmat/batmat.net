...
I view myself as a servant leader whose one of the important roles is to provide context and support to the people around me, so they are empowered to guide us in the right direction, so we can scale together.<=====en
I will spend the necessary time to autonomize teams so they can operate _without_ me on a daily basis.<=====en
...
I have spent most of my career working in teams that provide software tooling and processes to development teams. In part because of this love for technology and communities, I have been the link:https://www.toulousejug.org/[Toulouse Java User Group] leader for a number of years, during which we organized countless sessions on various subjects.<=====en
...
Bibliothèques & Framework:: Java EE, Lucene, ElasticSearch, Hibernate, GWT, JMeter, JNI... <=====fr
Serveurs:: JBoss, Tomcat, Apache HTTPd, Nginx <=====fr

Languages:: Java (development, Performance testing and optimization, JVM tuning...), Groovy, Bash, NodeJS, Scala, HTML/CSS/JavaScript, C/C++ <=====en
Libraries & Framework:: Java EE, Lucene, ElasticSearch, Hibernate, GWT, JMeter, JNI... <=====en
