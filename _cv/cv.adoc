...
*CloudBees* : Jenkins Evergreen Tools Hacker -- link:https://github.com/jenkins-infra/evergreen[Evergreen] is a brand new Open Source distribution of Jenkins,  automatically self updating. <=====en
